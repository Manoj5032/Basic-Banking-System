...
<body>
    ...
    <div class="container-fluid">
        <div class="row intro py-1" style="background-image: url(img/background.jpg);">
            <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                    ...
                    <h1 style="color:red"> Bank of TheSparksFoundation</h1>
                </div>
            </div>
        ...
        <div class="card-group">
            <div class="card">
                ...
                <img src="img/createuser.jpeg" alt="userimg" width="256" height="256" class="img-fluid">
                <br>
                <br>
    ...
    <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Manojsingh Rana</b><br>GRIP TheSparksFoundation.</p>
    </footer>
